sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/opensap-ui52-orders/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.opensap-ui52-orders.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.opensap-ui52-orders",
					async: true
				},
				hash: oOptions.hash,
